      ...
      <div className="space-y-8 print:hidden">
        ...
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap shrink-0">
          <button
            ...
            className="px-3.5 py-2 rounded-xl text-xs font-bold neo-btn bg-white hover:bg-slate-50 text-slate-800 border border-slate-200/80 transition-all flex items-center gap-1.5 shadow-2xs active:scale-95 cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none whitespace-nowrap"
